...
public:
    ...
    ReturnVal intersect(const Ray & ray) const override;	// Will take a ray and return a structure related to the intersection information. You will implement this.
